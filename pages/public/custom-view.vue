...
import shHotGoods from '@/pages/index/components/sh-hot-goods.vue';
import shMenu from '@/pages/index/components/sh-menu.vue';
import shAdv from '@/pages/index/components/sh-adv.vue';
import shCoupon from '@/pages/index/components/sh-coupon.vue';
import shSeckill from '@/pages/index/components/sh-seckill.vue';
import shGroupon from '@/pages/index/components/sh-groupon.vue';
import shRichtext from '@/pages/index/components/sh-richtext.vue';
import shNav from '@/pages/index/components/sh-nav.vue';
import shUserinfo from '@/pages/index/components/sh-userinfo.vue';
import shGrid from '@/pages/index/components/sh-grid.vue';
import shTitleCard from '@/pages/index/components/sh-title-card.vue';
import shOrder from '@/pages/index/components/sh-order.vue';
import shWallet from '@/pages/index/components/sh-wallet.vue';
// #ifdef MP-WEIXIN
import { HAS_LIVE } from '@/env';
import shLive from '@/pages/index/components/sh-live.vue';
// #endif
