...
export default {
	...
	cinema: {
		...
		playList: {
			url: 'web/app/api/playList',
			auth: false,
			method: 'POST',
			// desc: '机台列表',
		},
		playMessage: {
			url: 'web/app/api/playMessage',
			auth: false,
			method: 'POST',
			// desc: '机台列表',
		},
	...
	goods: {
		lists: {
			url: 'web/V8/getMixPackage',
			auth: false,
			method: 'POST',
			// desc: '商品列表',
		},
		detail: {
			url: 'web/V8/getPackageDetailInfo',
			auth: false,
			method: 'POST',
			// desc: '商品详情',
		},
		commodityList: {
			...
			url: 'web/memberGoods/addGoodsOrder',
			auth: true,
			method: 'POST',
			// desc: '卖品余额支付生成订单',
		},getMixPackageOrderList: {
			url: 'web/V8/getMixPackageOrderList',
			auth: true,
			method: 'POST',
			// desc: '卖品订单',
		},depositMixPackage: {
			url: 'web/V8/depositMixPackage',
			auth: true,
			method: 'POST',
			// desc: '卖品确认订单',
		},getMixPackageOrderDetail: {
			url: 'web/V8/getMixPackageOrderDetail',
			auth: true,
			method: 'POST',
			// desc: '卖品订单明细',
		},payCoinMoney: {
			...
			url: 'web/memberCoin/addCoinOrder ',
			auth: true,
			method: 'POST',
			// desc: '游戏币支付余额支付',
		},veCoin: {
	...
	user: {
		info: {
			...
			url: 'web/V8/getMiniAuth',
			auth: true,
			method: 'GET',
			// desc: '获取智科公众号id',
		},getCustomerList: {
			url: 'web/V8/getCustomerList',
			auth: true,
			method: 'POST',
			// desc: '获取智科公众号id',
		},balance: {
			...
			url: 'web/V8/memberBindSimple',
			auth: true,
			method: 'POST',
			// desc: '用户绑卡',
		},createMember: {
			url: 'web/V8/createMember',
			auth: true,
			method: 'POST',
			// desc: '成为会员',
		},deduction: {
	...
	coupons: {
		...
		couponIssueList: {
			url: 'web/couponIssue/couponIssueList',
			auth: true,
			method: 'POST',
			// desc: '个人中心可领取优惠券',
		},
		...
		get: {
			url: 'web/memberCouponDetail/getCoupon',
			auth: true,
			method: 'POST',
			// desc: '领取',
		},
